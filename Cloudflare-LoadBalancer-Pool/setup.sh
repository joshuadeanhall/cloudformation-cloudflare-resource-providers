...
cat test/integ-template.yml | sed "s/ACCOUNT_ID/${ACCOUNT_ID}/g" | sed "s/IP_ADDRESS/${DOMAIP_ADDRESS}/g" | sed "s/IP_ADDRESS_2/${IP_ADDRESS_2}/g" | sed "s/MONITOR_ID/${MONITOR_ID}/g" > test/integ.yml